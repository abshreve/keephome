 ...
 */
add_image_size( 'press_release_feature_mobile', 617, 725, true );
add_image_size( 'blog_feature_mobile', 517, 725, true );
add_image_size( 'post_thumbnail', 700, 560, true );
add_image_size( 'recommended_post_desktop', 906, 725, true );
add_image_size( 'component_slide', 922, 614, true );
add_image_size( 'media_grid', 209, 141, true );
add_image_size( 'logo', 604, 308, true );
